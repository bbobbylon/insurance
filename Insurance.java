		...
		do {
			...
			if (choice == 1) {
				...
				if (file.equals("T")) {
					...
					if (MemberWriter.writeMembersToTextFile("members.txt", members)) {
					...
					if (MemberWriter.writeMembersToBinary("members.bin", members)) {
					...
					if (MemberWriter.writeMembersToXML("members.xml", members)) {
